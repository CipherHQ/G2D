...
public class ActivityNetguardMain extends BaseActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private TextView vpnTv = null;
    private Switch vpnSwitch = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setUpToolbarWithBackButton((Toolbar) findViewById(R.id.app_bar).findViewById(R.id.toolbar), "Setup VPN");
        running = true;
        settingFilterEnable();
        ...
        ivMetered = actionView.findViewById(R.id.ivMetered);
         ...
         vpnTv = findViewById(R.id.vpn_tv);
...
//        getSupportActionBar().setTitle(null);
        ...
        ivQueue.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                ...
                Toast toast = Toast.makeText(ActivityNetguardMain.this, R.string.msg_queue, Toast.LENGTH_LONG);
                toast.setGravity(
        ...
        // On/off switch
        if(enabled) {vpnTv.setText(getResources().getString(R.string.vpn_is_running));}
        ...
        vpnSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                        ...
                        if (getPackageName().equals(alwaysOn)) {
                            if (prefs.getBoolean("filter", false)) {
                                ...
                                if (lockdown != 0) {
                                    ...
                                    Toast.makeText(ActivityNetguardMain.this, R.string.msg_always_on_lockdown, Toast.LENGTH_LONG).show();
                                    return;
                                }
                            }
                        } else {
                            vpnSwitch.setChecked(false);
                            Toast.makeText(ActivityNetguardMain.this, R.string.msg_always_on, Toast.LENGTH_LONG).show();
                            return;
                        }

                    boolean filter = prefs.getBoolean("filter", false);
                    if (filter && Util.isPrivateDns(ActivityNetguardMain.this))
                        Toast.makeText(ActivityNetguardMain.this, R.string.msg_private_dns, Toast.LENGTH_LONG).show();

                    try {
                        final Intent prepare = VpnService.prepare(ActivityNetguardMain.this);
                        if (prepare == null) {
                            Log.i(TAG, "Prepare done");
                            onActivityResult(REQUEST_VPN, RESULT_OK, null);
                        } else {
                            // Show dialog
                            LayoutInflater inflater = LayoutInflater.from(ActivityNetguardMain.this);
                            View view = inflater.inflate(R.layout.vpn, null, false);
                            dialogVpn = new AlertDialog.Builder(ActivityNetguardMain.this)
                                    .setView(view)
                                    .setCancelable(false)
                    ...
                    vpnTv.setText(getResources().getString(R.string.vpn_is_running));
                } else {
                    ServiceSinkhole.stop("switch off", ActivityNetguardMain.this, false);
                    vpnTv.setText(getResources().getString(R.string.tap_to_turn_on_vpn));
                }
        ...
        ivMetered.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                int location[] = new int[2];
                actionView.getLocationOnScreen(location);
                Toast toast = Toast.makeText(ActivityNetguardMain.this, R.string.msg_metered, Toast.LENGTH_LONG);
                toast.setGravity(
                        Gravity.TOP | Gravity.LEFT,
      ...
      //  getSupportActionBar().setCustomView(actionView);
        ...
        swipeRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                Rule.clearCache(ActivityNetguardMain.this);
                ServiceSinkhole.reload("pull", ActivityNetguardMain.this, false);
            ...
            iab = new IAB(new IAB.Delegate() {
                ...
                public void onReady(IAB iab) {
                    try {
                        ...
                        if (!IAB.isPurchased(ActivityPro.SKU_LOG, ActivityNetguardMain.this))
                            prefs.edit().putBoolean("log", false).apply();
                        if (!IAB.isPurchased(ActivityPro.SKU_THEME, ActivityNetguardMain.this)) {
                            if (!"teal".equals(prefs.getString("theme", "teal")))
                                prefs.edit().putString("theme", "teal").apply();
                        }
                        if (!IAB.isPurchased(ActivityPro.SKU_NOTIFY, ActivityNetguardMain.this))
                            prefs.edit().putBoolean("install", false).apply();
                        if (!IAB.isPurchased(ActivityPro.SKU_SPEED, ActivityNetguardMain.this))
        ...
        llSupport.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(getIntentPro(ActivityNetguardMain.this));
            }
        });
...
//                Toast on = Toast.makeText(ActivityNetguardMain.this, R.string.msg_on, Toast.LENGTH_LONG);
...
//            SwitchCompat swEnabled = getSupportActionBar().getCustomView().findViewById(R.id.swEnabled);
            if (vpnSwitch.isChecked() != enabled) {
                if(enabled) {vpnTv.setText(getResources().getString(R.string.vpn_is_running));}
                vpnSwitch.setChecked(enabled);
            ...
            if (adapter != null)
                if (intent.hasExtra(EXTRA_CONNECTED) && intent.hasExtra(EXTRA_METERED)) {
                    ...
                    if (intent.getBooleanExtra(EXTRA_CONNECTED, false)) {
                        ...
                        ivMetered.setVisibility(Util.isMeteredNetwork(ActivityNetguardMain.this) ? View.VISIBLE : View.INVISIBLE);
                    } else {
...
//        return true;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_pro:
                startActivity(new Intent(ActivityNetguardMain.this, ActivityPro.class));
                return true;
    ...
    private void updateApplicationList(final String search) {
        ...
        new AsyncTask<Object, Object, List<Rule>>() {
            ...
            protected List<Rule> doInBackground(Object... arg) {
                return Rule.getRules(false, ActivityNetguardMain.this);
            }
    ...
    private void menu_about() {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            private short tap = 0;
            private Toast toast = Toast.makeText(ActivityNetguardMain.this, "", Toast.LENGTH_SHORT);
        ...
        btnRate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(getIntentRate(ActivityNetguardMain.this));
            }
        });
    ...
    public void settingFilterEnable() {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(this);
//        boolean filter = prefs.getBoolean("filter", false);
...
//        boolean track_usage = prefs.getBoolean("track_usage", false);
        ...
        prefs.edit().putBoolean("use_hosts", true).apply();
    }
}
